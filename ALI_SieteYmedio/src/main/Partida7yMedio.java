...
public class Partida7yMedio {
	...
	public static void main(String[] args) {
		...
		Carta[] cartasJugador = new Carta[10];								//Defino un valor maximo de 10 ya que es imposible llegar a ese tamaño
		...
		//Crear Baraja nueva de 40 cartas
		 ...
		 Baraja misCartas = new Baraja("Española", 1);						//Se crea una baraja nueva de 40 cartas
	        misCartas.barajar();											//Se baraja el mazo
	        
	        System.out.println("Barajamos y enseñamos todas las cartas de la baraja para averiguar la integridad de la baraja");
	     ...
	     //Le toca a la banca
	     //La banca siempre enseña sus cartas
